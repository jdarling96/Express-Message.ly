...
class User {
  ...
  static async register({username, password, first_name, last_name, phone}) {
   if([username,password,first_name,last_name,phone].includes('')) {
    throw new ExpressError('All fields must be filled out', 404) 
   }
  ...
  static async updateLoginTimestamp(username) {
    if(!username) throw new ExpressError('Username required', 404)
